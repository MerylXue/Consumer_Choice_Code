...
## This file defines the data structure
...
#  A data structure, each piece of data forms by the choice and choice set
...
#  A data structure, each piece of data forms by the choice probabilities and a choice set
class Transaction_Extend(object):
    @classmethod
    def from_json_prob(cls, json_list):
        return [cls(d['prob'], d['offered_products']) for d in json_list]
    ...
    def __init__(self, prob, offered_products):
        self.prob = prob
        self.offered_products = offered_products

    def as_json(self):
        return {'prob': self.prob, 'offered_products': self.offered_products}

    def __hash__(self):
        return (tuple(self.prob), tuple(self.offered_products)).__hash__()

    def __eq__(self, other):
        return self.prob == other.prob and self.offered_products == other.offered_products

    def __repr__(self):
        return "<Test probability: %s ; Offered products: %s >" % (self.prob, self.offered_products)
